  ...
  return (
    <div className="flex h-16 items-center justify-between border-b border-slate-200 px-4">
      <Link to="/dashboard" className="flex min-w-0 items-center gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-600 to-violet-600 text-white shadow-sm ring-1 ring-white/40">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-0.5 inline-flex max-w-full items-center rounded-full bg-indigo-50 px-2 py-0.5 text-[10px] font-extrabold uppercase leading-none tracking-wide text-indigo-700 ring-1 ring-indigo-100">
            Admin Console
          </div>
        </div>
      </Link>
