          ...
          {prices.map((price: any, index: number) => (
            <div key={index} className="border rounded-md p-3 bg-muted/10">
              <div className="flex justify-between font-medium text-sm">
                ...
                <span className="text-primary font-bold">{fmtVnd(Number(price.pricePerNight) || 0)}/đêm</span>
              </div>
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/40 flex items-start justify-center p-4 pt-10 z-50 overflow-y-auto" onClick={onClose}>
        <div className="bg-card border rounded-lg p-6 w-full max-w-5xl my-8" onClick={e => e.stopPropagation()}>
