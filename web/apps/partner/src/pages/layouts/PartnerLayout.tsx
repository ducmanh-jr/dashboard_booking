...
import { PartnerNotification, User } from "../../shared/types";
...
export function PartnerLayout({ children, user, onLogout }: { children: ReactNode; user: User; onLogout: () => void }) {
  ...
  const navItems: NavItem[] = [
    { label: "Khách sạn", description: "Hồ sơ & trạng thái", path: "/", icon: <IconHotel /> },
